  ...
  if (results.data.totalItems === 0) {
    ...
    works = works.map(work => {
      const book = {},
        ...
        author = work.volumeInfo.authors,
      ...
      if (author !== undefined && author.length > 0) { book.author = author[0] };
...
export default {
  search: function (term) {
    const encodedURI = window.encodeURI(`https://www.googleapis.com/books/v1/volumes?q=${term}&maxResults=40`);
